...
>(({ className, children, ...props }, ref) => (
    <DialogPortal>
        ...
        >
            {children}
            <DialogPrimitive.Close className="absolute right-4 top-4 border-2 border-black bg-white p-1 transition-all hover:bg-neo-pink active:translate-x-[1px] active:translate-y-[1px]">
...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Title
        ref={ref}
        className={cn(
            "text-2xl font-black uppercase tracking-tight text-black",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Description
        ref={ref}
        className={cn("text-base font-medium text-black/60", className)}
        {...props}
    />
));
